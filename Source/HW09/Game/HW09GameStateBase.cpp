...
FString AHW09GameStateBase::GenerateSecretNumber()
{
...
bool AHW09GameStateBase::IsGuessNumberString(const FString& InNumberString)
{
	bool bCanPlay = false;
...
FString AHW09GameStateBase::JudgeResult(const FString& InSecretNumberString, const FString& InGuessNumberString)
{
